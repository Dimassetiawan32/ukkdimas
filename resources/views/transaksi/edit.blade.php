            ...
            <form action="{{route('transaksi.update', $transaksi->id)}}" method="POST">
                ...
                <div class="px-4">
                    <div class="form-group row">
                        <label for="" class="col-sm-2 col-form-label font-weight-bold">No Nota</label>
                        <div class="col-sm-4">
                            <input type="" class="form-control" name="no_nota" id="" value="{{$transaksi->no_nota}}">
                        </div>
                    </div>
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="number" class="form-control" name="bayar" id="" value="{{$transaksi->bayar}}">
                        </div>
                    </div>
                    <div class="form-group row">
                        <label for="" class="col-sm-2 col-form-label font-weight-bold">Nama Pelanggan</label>
                        <div class="col-sm-4">
                            <input type="" class="form-control" name="pelanggan" id="" value="{{$transaksi->pelanggan}}">
                            <div class="pt-3">
